...
| Política si no se puede auditar | decision | dirección cerrada (weekly 05-ago): por nivel de riesgo/rol del usuario; default actual fail-open para todos; falta spec corta + ¿auditar errores? | BASA_AUDIT_FAIL, weekly |
...
- Fuente de verdad en repo: `basa-guardian/specs/ROADMAP-pisos.md` · Versión visual: `TechTree-BasaGuardian.html`
