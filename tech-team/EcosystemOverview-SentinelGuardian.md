...
bundles y white-label · instalaciones · updates · emisión de licencias · CLI sentinel-admin · CI/CD · TLS de onboarding · distribución de la extensión · VPS demo → Install & Factory (Falime). Contratos: en ambos roadmaps.

## Fuentes

- Fact-check 04→05-ago sobre main 7071498 · pase por panel real (App.tsx, UserPortal.tsx, ModelsPage.tsx)
- Versión visual: `EcosystemOverview-SentinelGuardian.html` · Tech tree: `TechTree-SentinelGuardian.{html,md}`
