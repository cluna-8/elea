...
Fuente canónica de verdad: ``litellm/extensions/sentinel_guardian_policy.py`` (config
...
# ── Patrones replicados de sentinel_guardian_policy.py ────────────────────────────────

# STRUCTURED_ID_PATTERNS_BY_REGION["eu"]["PHONE_NUMBER"] (sentinel_guardian_policy.py:89):
...
# STRUCTURED_ID_PATTERNS_BY_REGION["eu"]["PASSPORT"] (sentinel_guardian_policy.py:85):
...
# PII_PATTERNS["EMAIL_ADDRESS"] (dev-fallback, sentinel_guardian_policy.py:58). El
