...
- [x] T001 Verificar el entorno de evidencia vivo: stack dev arriba (backend :8091, motor
...
- [x] T002 **Evidencia de shapes (D2)**: instrumentación TEMPORAL de los post hooks en el
...
- [x] T003 [P] **Tests RED de los tres root causes** en
...
- [x] T008 [US2] `_unmask_response_inplace` acepta respuesta **dict raíz** (D1):
...
- [x] T009 [US2] Tests unit no-streaming en VERDE: dict-Anthropic con text/thinking/
...
- [x] T010 [US2] Verificación viva (quickstart #1): respuesta JSON con el valor original;
...
- [x] T013 **e2e contra motor vivo (FR-007)** en
...
- [x] T016 [P] **Registro 019 (FR-009)**: promover en
