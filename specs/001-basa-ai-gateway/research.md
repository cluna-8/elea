# Research: Basa Secure AI Gateway (by basa dev)
...
- **White-Labeling**: By routing all frontend requests through the FastAPI wrapper, we ensure that the user never sees LiteLLM headers, URLs, or error messages. Any LiteLLM-specific errors will be caught by the wrapper and translated into custom "Basa Secure AI Gateway" errors.
