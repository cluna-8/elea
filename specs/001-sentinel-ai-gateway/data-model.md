# Data Model: Sentinel Secure AI Gateway (by sentinel dev)

This document describes the database schema for the custom administration backend of the Sentinel Secure AI Gateway. The schema will be implemented in **PostgreSQL**.
...
- `key_preview` (VARCHAR): First few characters of the key (e.g., `sentinel_sk_...`).
