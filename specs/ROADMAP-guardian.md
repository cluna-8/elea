...
**Última actualización**: 2026-08-12 — **el examen**: el **gate 125 PASÓ** (primer número oficial: run
...
| 017 | Auth hardening & Multi-Tenant RBAC + SSO | JF (gate: Cristian) | **P1** (re-priorizada 12-ago) | Roadmap — **camino crítico del 5-SEP**: 0 líneas escritas y debe caber entera en C2. Spec (SSO OIDC Entra+Google escalón 1 + matriz de roles con 034 y rol Lectura) se escribe en el colchón de C1 (13–21 ago) | III, SC-3 | **C3, C4, C5**, D5 |
| 018 | Compliance Enforcement Tiers + retention purge | JF | **P1** (re-priorizada 12-ago) | Roadmap — **camino crítico del 5-SEP** (la purga real al día 91 es la mitad RGPD de la promesa); spec en el colchón de C1, junto a DSAR [#62](https://github.com/DrZuzzjen/basa-guardian/issues/62) | II [D3] | A4 |
...
| 034 | Rol `auditor` canónico read-only | JF | P2 | **Roadmap — sin spec** (research 2026-07-30, veredicto en [#52](https://github.com/DrZuzzjen/basa-guardian/issues/52)). El quick-win [PR #54](https://github.com/DrZuzzjen/basa-guardian/pull/54) (**mergeado 2026-08-04**) sólo expone el `compliance_officer` existente **declarando que NO es read-only**; la **017** lo absorbe en su matriz definitiva. Est. 1-1.5 d. **Camino crítico del 5-SEP**: spec junto a 017/018/rol Lectura en el colchón de C1 (13–21 ago) | III, SC-3, II | adelanta parte de **017** |
| **035** | Load harness + gates de carga 125/250/500 — instrumento de La ITV | JF (ejecuta La ITV) | **P1** | **Implementada en `main`** (spec+plan por speckit; consolidada [PR #122](https://github.com/DrZuzzjen/basa-guardian/pull/122), corridas reales [PR #163](https://github.com/DrZuzzjen/basa-guardian/pull/163)+[#164](https://github.com/DrZuzzjen/basa-guardian/pull/164) con doble gate adversarial). **Estrenada el 12-ago: gate 125 PASS** (4/4 SLOs de oro; evidencia firmada `tech-team/examenes/20260812/`) + rodilla de capacidad medida (10–25× sede en ccx33). Deuda del instrumento consolidada: [#168](https://github.com/DrZuzzjen/basa-guardian/issues/168) (ciclo 250). Encargo vigente: dimensionamiento de instancia por tier (sellado JF 12-ago) | II, VIII, I | los gates son el pilar de ESCALA del DoD de Fase 0 |
